...
mkdir -p media
chmod 755 media
# Ensure Nginx can read media files
chown -R :www-data media
echo "    ✓ Media permissions configured"
...
echo "   - SERVE_MEDIA=False (Nginx will serve media files)"
...
echo "   - CORS_ALLOWED_ORIGINS=https://rmmdc.edu.bd,https://www.rmmdc.edu.bd"
echo "   - CSRF_TRUSTED_ORIGINS=https://rmmdc.edu.bd,https://www.rmmdc.edu.bd"
echo "   - REACT_APP_API_URL=https://rmmdc.edu.bd/api"
echo "   - REACT_APP_BACKEND_URL=https://rmmdc.edu.bd"
echo ""
echo "2. Verify media serving configuration:"
echo "   - Check /etc/nginx/sites-enabled/omar-smc has /media/ and /django-static/ aliases"
echo "   - Verify media directory exists: ls -la backend/media/"
echo "   - Check permissions: stat backend/media/ | grep -i access"
echo ""
echo "3. Restart gunicorn after editing:"
echo "   systemctl restart gunicorn"
echo ""
echo "4. Verify API is working:"
echo "   curl https://rmmdc.edu.bd/api/notices/"
echo ""
echo "5. Test media file serving:"
echo "   curl -I https://rmmdc.edu.bd/media/  # Should not 404"
echo ""
echo "6. Test in browser:"
echo "   https://rmmdc.edu.bd"
echo "   Check browser console (F12) for errors"
echo "   Verify avatar images load correctly"
echo ""
