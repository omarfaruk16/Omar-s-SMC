...
from .views import FeeViewSet, PaymentViewSet, SSLCommerzInitView, SSLCommerzIPNView, SSLCommerzReturnView
...
urlpatterns = [
    ...
    path('payments/sslcommerz/return/', SSLCommerzReturnView.as_view(), name='sslcommerz-return'),
